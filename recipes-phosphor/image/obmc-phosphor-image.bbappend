...
IMAGE_INSTALL_append = "obmc-ikvm phosphor-webui virtual-obmc-host-ipmi-kcs phosphor-ipmi-net phosphor-ipmi-ipmb phosphor-ipmi-host nbd-client bmcweb phosphor-image-signing\
                        "
